    ...
    private void getData(){
        ...
        databaseReference.child("Profile").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                StorageReference imageRef = storageReference.child("Images").child("ProfilePic").child(firebaseAuth.getUid());
                imageRef.getBytes(ONE_MB).addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ViewProfileActivity.this, "Couldn't Load The Profile Pic!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
